// restricting the user from submitting form under 2 conditions:
// - form should be changed    (isDirty property from form state)
// - form should be valid      (isValid property from form state)
