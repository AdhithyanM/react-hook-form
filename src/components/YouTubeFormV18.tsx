// Enhancing the form submission with error handler
...
const YouTubeFormV18 = () => {
  ...
  return (
    <div>
      ...
      <button onClick={handleSubmit(onSubmit, onError)} type="button">
        Submit
      </button>
