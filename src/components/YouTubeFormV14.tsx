// setValues method to set form values programmatically.
...
const YouTubeFormV14 = () => {
  ...
  const handleSetValue = () => {
    setValue("username", ""); // makes the username empty
    // Note: calling setValue will not change the field state of dirty or touched
    // If that needs to be done, pass options as the 3rd argument
    setValue("channel", "EA", {
      shouldValidate: true,
      shouldDirty: true,
      shouldTouch: true,
