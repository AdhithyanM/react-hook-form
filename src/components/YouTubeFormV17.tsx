// Disabling fields
// Note: When the field is disabled the validation will not be checked.
...
type FormValues = {
  ...
  channel: string;
  social: {
    twitter: string; // let's try disabling this field.
    facebook: string;
  };
  phoneNumbers: string[];
  phNumbers: {
